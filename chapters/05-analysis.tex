...
a \textit{Load access fault} exception), while sizes $64^2$ and above resulted in a linker failure due to overflowing memory regions.}. 
...
\noindent The simulation results were saved to a file, and are present in the table (\ref{table:cache_results}).

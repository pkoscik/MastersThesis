...
% PZIE changed tense for consistency
...
% PZIE: You have inconsistent tenses here as well. I would suggest going with the past tense in this whole 5.3 chapter
...
% PZIE: So the block based approach for a large matrix is generally worse?
% I think you should add a comment on these results here, even a short one
% PZIE: Oh, it's there in 5.4. Maybe at least announce that you comment on these in 5.4?
...
%PZIE this is a surprisingly low number of memory accesses tbh

...
\end{tabular}
\caption{Performance Metrics for Different Sizes}
...
\end{tabular}
\caption{Performance Metrics for Matrix Size 16}
\label{tab:performance_metrics_16}
\end{table}
\end{center}

\paragraph{Matrix Size 32}
\begin{center}
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|c|c|}
...
\end{tabular}
\caption{Performance Metrics for Matrix Size 32}
\label{tab:performance_metrics_32}
\end{table}
\end{center}

\paragraph{Matrix Size 64}
\begin{center}
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|c|c|}
...
\end{tabular}
\caption{Performance Metrics for Matrix Size 64}
\label{tab:performance_metrics_64}
\end{table}
\end{center}

\paragraph{Matrix Size 128}
\begin{center}
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|c|c|}
...
\end{tabular}
\caption{Performance Metrics for Matrix Size 128}
\label{tab:performance_metrics_128}
\end{table}
\end{center}

\paragraph{Matrix Size 256}
\begin{center}
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|c|c|}
...
\end{tabular}
\caption{Performance Metrics for Matrix Size 256}
